        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">このページでは、価格比較ツールの基本的な使い方を説明します。</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="p-4 rounded-lg bg-white border">
                  ...
                  <p className="text-sm text-gray-600">必要に応じて、よく行く店舗を登録します</p>
                </div>
                <div className="p-4 rounded-lg bg-white border">
                  ...
                  <p className="text-sm text-gray-600">よく買う商品の価格を登録します（未登録店舗はここで入力しても登録可能）</p>
                </div>
                <div className="p-4 rounded-lg bg-white border">
                  ...
                  <p className="text-sm text-gray-600">店頭で商品情報を入力して比較します（登録なしでもOK）</p>
                </div>
              </div>
              <div className="mt-4">
                <Link href="/dashboard" className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700">
                  ダッシュボードへ戻る
        ...
        <section className="card mb-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="p-4 rounded-lg bg-white border">
              ...
              <p className="text-sm text-gray-700">A. 入力した価格がそのまま使われます。運用ルールをチーム内で揃えてください。</p>
            </div>
            <div className="p-4 rounded-lg bg-white border">
              <p className="font-medium">Q. 単位が違う商品は比較できる？</p>
              <p className="text-sm text-gray-700">A. 種別ごとに単位が固定です。同じ種別内で比較してください。</p>
            </div>
            <div className="p-4 rounded-lg bg-white border">
              <p className="font-medium">Q. 店舗名や商品名は必須？</p>
              <p className="text-sm text-gray-700">A. 店舗名・商品名は任意です（メモ用途に便利）。</p>
            </div>
            <div className="p-4 rounded-lg bg-white border">
              <p className="font-medium">Q. データは保存される？</p>
              <p className="text-sm text-gray-700">A. はい。ログイン後、この端末に保存されます（サーバー同期は現在未対応）。</p>
            </div>
          </div>
        </section>
